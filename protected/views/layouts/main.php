...
<head>
	...
	<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/yiinka.js"></script>
	<?php }?>
</head>
	...
	<section>
		...
		<header>
			<div class="headerLeft">
				<a href="/"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/siteProof/logo.png" alt="" border="0"/></a>
			</div>
